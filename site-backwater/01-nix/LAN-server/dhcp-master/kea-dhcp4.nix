  ...
  services.kea = {
    ...
    dhcp4 = {
      ...
      settings = {
        ...
        # DDNS
        "ddns-qualifying-suffix" = "backwater.REDACTED-DOMAIN.TLD";
        # Force DDNS registration for all clients (reservation hostname, updates on renew)
              ...
              "high-availability" = [
                {
                  ...
                  "peers" = [
                    {
                      "name" = "achernar";
                      "url" = "http://172.22.0.108:8001/";
                      "role" = "primary";
                      "auto-failover" = true;
                    }
                    {
                      "name" = "lmc";
                      "url" = "http://172.22.0.114:8001/";
                      "role" = "standby";
                      "auto-failover" = true;
                    }
                  ];
