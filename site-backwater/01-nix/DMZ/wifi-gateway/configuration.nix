...

{
  imports =
    [ # Include the results of the hardware scan.
      ...
      # WiFi connection to Vanderbilt VuDevice
      ./wifi.nix
      # Policy routing for WiFi gateway functionality
      # ./routing.nix
    ];
  ...
  # Enable networking
  networking.networkmanager.enable = false;  # We manage interfaces manually
